...
{!! Form::open(array('route' => config('quickadmin.route').'.teams.store', 'id' => 'form-with-validation', 'class' => 'form-horizontal')) !!}

<div class="form-group">
    {!! Form::label('team_name', 'Team Name*', array('class'=>'col-sm-2 control-label')) !!}
    <div class="col-sm-10">
        {!! Form::text('team_name', old('team_name'), array('class'=>'form-control')) !!}
